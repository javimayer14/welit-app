...
export default function ChangePasswordForm(props) {
  ...
  const [hideNewPasswordRepeat, setHideNewPasswordRepeat] = useState(false);
  ...
  const updatePassword = () => {
    ...
    if (!password || !newPassword || !newPasswordRepeat) {
      ...
      !newPassword && (obj.newPassword = "No puede estar vacio");
      !newPasswordRepeat && (obj.newPasswordRepeat = "No puede estar vacio");
      setError(objError);
    } else {
      if (newPassword !== newPasswordRepeat) {
        setError({
          newPassword: "Las contraseñas no son iguales",
          newPasswordRepeat: "Las contraseñas no son iguales"
        });
      } else {
        setIsLoading(true);
